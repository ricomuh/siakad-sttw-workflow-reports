# Workflow Report: Rekap Kinerja Dosen Admin

**Tanggal**: 2026-05-12
**Role**: admin
**Modul**: siakad
**Fitur**: admin-rekap-kinerja-dosen
**Status**: ✅ Berhasil

## Deskripsi Workflow

Rekap kinerja dosen per semester (BKD/SKP).
...
**URL**: `http://127.0.0.1:8000/siakad/rekap-kinerja-dosen`

![Rekap Kinerja Dosen Admin](screenshots/01_rekap-kinerja.png)

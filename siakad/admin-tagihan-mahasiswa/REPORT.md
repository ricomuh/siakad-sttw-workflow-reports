# Workflow Report: Tagihan Mahasiswa Admin

**Tanggal**: 2026-05-12
**Role**: admin
**Modul**: siakad
**Fitur**: admin-tagihan-mahasiswa
**Status**: ✅ Berhasil

## Deskripsi Workflow

Daftar tagihan mahasiswa per periode.
...
**URL**: `http://127.0.0.1:8000/siakad/tagihan-mahasiswa`

![Tagihan Mahasiswa Admin](screenshots/01_tagihan.png)

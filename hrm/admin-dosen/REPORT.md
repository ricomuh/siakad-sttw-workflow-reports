# Workflow Report: HRM Admin Daftar Dosen
...
### 1. Buka halaman HRM Admin Daftar Dosen

**Deskripsi**: Akademik membuka halaman `/hrm/admin/dosen` melalui sidebar HRM Admin.

**URL**: `http://127.0.0.1:8000/hrm/admin/dosen`

![Halaman HRM Admin Daftar Dosen](screenshots/01_index.png)

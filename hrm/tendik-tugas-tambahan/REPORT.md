...
| 2 | Daftar Tugas Tambahan | `http://127.0.0.1:8000/hrm/tendik/kinerja/tugas-tambahan` | `missing-sidebar` | Halaman ini dicapai lewat quick action atau tombol sekunder karena tidak ada item sidebar langsung. | [Lihat](screenshots/01_index.png) | Medium |
| 3 | Form Tambah Tugas Tambahan | `http://127.0.0.1:8000/hrm/tendik/kinerja/tugas-tambahan` | `missing-feature` | Elemen aksi "/Tambah/i" tidak ditemukan pada area utama halaman. | [Lihat](screenshots/err_02_create.png) | High |
